...
<b-container fluid>
  <b-navbar toggleable="md" variant="transparent">
    <b-navbar-brand href="#">
      <div class="tagline"><b-link to="/"><img class="mr-30" width="30px" :src="iconGrey"/> Ecosystem<span class="tagline1">DAO</span></b-link></div>
    </b-navbar-brand>
    ...
    <b-collapse id="nav-collapse" is-nav>
      <b-navbar class="ml-auto">
        <b-nav-item to="/stxdao/proposals" class="nav-text marketplace-link">Proposals</b-nav-item>
        <b-nav-item to="/stxdao/membership" class="nav-text about-link">Membership</b-nav-item>
...
export default {
  ...
  data () {
    return {
      ...
      toggler: require('@/assets/img/Icon_ionic-md-options.svg')
    }
  },
  methods: {
    balance () {
