<template>
  <div class="d-flex justify-content-between">
    <div>
      <b-link
        class="border-right text-info mr-3 pr-3"
        :to="'/stxdao/community'"
      >
        RULES
      </b-link>
      <b-link
        ...
        class="mr-3 pr-3 text-info"
        to="/stxdao/proposals/create"
        :title="(canPropose) ? 'This account is able to propose' : 'Insufficient governance token balance to submit proposals to the DAO'"
      >
        NEW PROPOSAL
      </b-link>
    </div>
    <div class="d-flex justify-content-end">
      ...
      <span class="mr-4"><b-link
        v-if="isDaoDeployer && !isConstructed"
        v-b-tooltip.hover="{ variant: 'light' }"
        :title="'Construct a new DAO'"
        @click="constructDao"
      >CONSTRUCT</b-link></span>
      ...
      <span class="pointer mr-3">
        ...
        >
          <b-dropdown-item
            v-for="(status, index) in dateFilterNames"
            :key="index"
