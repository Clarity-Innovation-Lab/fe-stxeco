<template>
<div v-if="proposal" class="preview mb-5">
  <b-row>
    <b-col>
      <b-row>
        <b-col cols="4"><div>Now at</div></b-col>
        <b-col cols="8"><div>{{stacksTipHeight}}</div></b-col>
        <b-col cols="4"><div>Voting starts:</div></b-col>
        <b-col cols="8"><div>{{proposal.proposalData.startBlockHeight}}</div></b-col>
        <b-col cols="4"><div>Voting ends:</div></b-col>
        <b-col cols="8"><div>{{proposalEnds}}</div></b-col>
      </b-row>
    </b-col>
    <b-col>
      <b-row>
