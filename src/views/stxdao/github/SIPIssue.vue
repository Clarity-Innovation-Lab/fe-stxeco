        ...
        <div class="text-right text-xsmall">
          ...
          >
            <span
              ...
              :title="'Leave Comments on GitHub'"
            >comment <b-icon icon="arrow-up-right-square" /></span>
          </b-link>
        </div>
      </div>
      <h2>
        ...
        >
          <b-link
            :href="ghIssue.htmlUrl"
            target="_blank"
          >{{ ghIssue.title }}</b-link>
        </span>
      </h2>
      <div>
        ...
        <b-row class="">
          <b-col>
            <vue-markdown :source="ghIssue.body" />
          </b-col>
        </b-row>
        <b-row class="">
          <b-col>
            ...
            <div>
              ...
              >
                <span
                  v-b-tooltip.hover="{ variant: 'dark' }"
                  :title="'Leave Comments on GitHub'"
                >Join the Conversation on GitHub <b-icon icon="arrow-up-right-square" /></span>
              </b-link>
            </div>
          </b-col>
        </b-row>
