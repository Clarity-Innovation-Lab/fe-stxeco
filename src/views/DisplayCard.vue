      ...
      >
        ...
        >
          ...
          <div>
            <p>
              <a
                class="text-info pointer mx-4"
                :href="webWalletLink"
                target="_blank"
              >Hiro Web Wallet <b-icon
                class="ml-3"
      ...
      <template #footer>
        ...
        >
          <b-button variant="light">
            <a href="https://btc.us/">Claim BTC Address</a>
          </b-button>
        </div>
        <div
          v-else-if="webWalletNeeded"
          class="text-center"
        >
          <b-button variant="light">
            <a
              class="text-white pointer mx-4"
              :href="webWalletLink"
              target="_blank"
            >Stacks Web Wallet <b-icon
              class="ml-3"
              icon="arrow-up-right-square-fill"
            /></a>
          </b-button>
